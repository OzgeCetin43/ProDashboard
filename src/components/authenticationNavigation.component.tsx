                  ...
                  {isSubMenuOpen === link.name &&
                    link.subMenu?.map((subLink) => (
                      <Link
                        ...
                        className={`block p-2 rounded-xs ml-2 ${location.pathname === subLink.path ? "bg-accent-primary text-white font-bold hover:bg-accent-hover" : "text-text-primary hover:bg-bg-primary hover:text-accent-primary"}`}
                      >
                        {subLink.name}
                      </Link>
                    ))}
