...
const PostsTab: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-2 text-text-primary">
      ...
      <div className="flex flex-col justify-center gap-2 p-2 bg-bg-primary border border-border-color rounded-xs">
        <div className="flex items-center gap-2">
          <img src={avatar} alt="avatar" className="w-20 h-20 rounded-xs" />
          <div className="flex flex-col justify-center gap-2">
            <h3 className="font-bold">Cameron Doe</h3>
            <p className="text-text-secondary">@camerondoe</p>
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-2">
          <span className="font-bold text-accent-primary">camerondoe</span>
      ...
      <div className="flex flex-col items-end gap-2 bg-bg-secondary rounded-xs p-2 border border-border-color">
        <input type="file" ref={fileInputRef} className="hidden" />
        <div
          className="w-full border-2 border-dashed border-border-color flex items-center justify-center text-md rounded-xs h-20 cursor-pointer text-text-secondary"
